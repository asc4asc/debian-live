...
echo Install Debian
debootstrap --arch=amd64 --variant=minbase testing $HOME/LIVE_BOOT/chroot http://ftp.us.debian.org/debian/
...
echo Copy output
cp -v $HOME/LIVE_BOOT/debian-custom.iso /output/debian-live-minimal-x86_64.iso
chmod -v 666 /output/debian-live-minimal-x86_64.iso
ls -lah /output
